...
void led_bright( )
{
    while (1) {
         ...
         */
        //test semaphore
        if(a == 1) { //use gdb change the a,then watch it.
...
{
    while (1) {
        semaphore_take(sem,1);//You can see it end with false if you don't change the value of a.
        //semaphore_take(sem,50);
